...
<div className=" min-h-full min-w-full ">
      <div className=" flex">
        <div className="  w-full p-8 flex flex-col h-full flex-wrap sm:flex-row justify-center ">
          <div
            onClick={clickedLeft}
            className=" hidden lg:flex w-9 m-auto active:scale-50 align-middle h-full"
          >
            <div className="  text-5xl hover:scale-y-150  delay-150 hover:cursor-pointer  text-gray-500">
              {" "}
              &lt;{" "}
            </div>
          </div>
          <div className=" flex w-fit flex-col justify-center sm:justify-evenly sm:flex-row ">
            <div className=" m-auto justify-center col-span-1 w-56 h-auto md:max-h-60  md:w-60 overflow-clip md:flex md:justify-evenly  ">
